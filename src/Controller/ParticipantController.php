...
final class ParticipantController extends AbstractController
{
     ...
     */
    #[Route('/participant/add/{race}/{raceUuid}', name: 'app_participant_add', methods: ['GET', 'POST'])]
    ...
    #[Route('/participant/join/{race}/{raceUuid}/{participant}', name: 'app_participant_join', methods: ['GET'])]
     ...
     */
    #[Route('/participant/{id}', name: 'app_participant_delete', methods: ['POST'])]
    #[IsGranted('access_admin')]
