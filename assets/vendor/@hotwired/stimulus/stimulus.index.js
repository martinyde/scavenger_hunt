        ...
        if (null != s) {
            ...
            if (
                ...
                (this.stringMap.delete(e),
                    t && this.stringMapKeyRemoved(s, e, t));
...
class B {
    ...
    fetchValuesByTokenForElement(e) {
        ...
        return (
            t || ((t = new Map()), this.valuesByTokenByElement.set(e, t)),
            t
        );
    }
    parseToken(e) {
...
class T {
    constructor(e, t) {
        ((this.context = e),
            (this.delegate = t),
            (this.targetsByName = new w()));
    }
    start() {
        this.tokenListObserver ||
            ((this.tokenListObserver = new F(
                this.element,
                this.attributeName,
                this,
            )),
...
class V {
    constructor(e, t) {
        ((this.logDebugActivity = (e, t = {}) => {
            ...
            ((t = Object.assign(
                { identifier: s, controller: r, element: n },
                t,
            )),
                            ...
                            [`${t}Outlet`]: {
                                get() {
                                    const t = this.outlets.find(e),
                                        s =
                                            this.outlets.getSelectorForOutletName(
                                                e,
                                            );
                                    if (t) {
                                        const s = ee(this, t, e);
